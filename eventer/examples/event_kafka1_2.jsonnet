...
local rnd_data = get_rand_data();

{
    id: get_integer(1, 10),
    time: get_timestamp("2021-12-01", "2021-12-31", "12h"),
    group_id: get_instance_id("dummy_instance_id"),
    dataset: get_dataset("dummy_dataset"),
    country: get_one_of("ru, us, jp, cn"),
    name: rnd_data["first_name"],
    session_id: get_integer(1, 3),
    page_id: get_integer(1, 2),
